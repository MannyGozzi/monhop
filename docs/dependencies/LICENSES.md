...
Generated from Cargo.lock. Includes all resolved target and build dependencies. Runtime-only inventories are adjacent files. Run cargo deny for the enforceable license/source policy.
...
| mio | 1.2.3 | MIT |
| monhop | 0.2.1 | GPL-3.0-or-later |
| monhop-core | 0.2.1 | GPL-3.0-or-later |
| monhop-desktop | 0.2.1 | GPL-3.0-or-later |
| monhop-platform-macos | 0.2.1 | GPL-3.0-or-later |
| monhop-platform-windows | 0.2.1 | GPL-3.0-or-later |
| monhop-protocol | 0.2.1 | GPL-3.0-or-later |
| monhop-transport | 0.2.1 | GPL-3.0-or-later |
